...
- [ ] Confirm `amplify_outputs.json` is generated by the sandbox (gitignored — each environment generates its own)
...
- Amplify Gen 2 sandbox deployed; `amplify_outputs.json` generated locally
